...
### One: Compile this document as is

That way you will know you are starting with a working document.  Note that the document is already set up to read in the data, so you will not have to do this again.  (For the professionals: the data reading statements have been cached, so it will not take much time to read the data *after* the first time you compile the document.)
