...
```{r include=FALSE}
knitr::opts_chunk(tidy=FALSE)
```

# Workshop Schedule

* Wednesday May 27: 8:30am - 4:00pm
    Morning and afternoon sessions with a break for lunch.
...
* Making sure you have access to the software.
    * [R 3.1 or more recent](http://cran.rstudio.com/)
...
1. Brief review of setup and plans [DTK, 10]
2. Introduce your neighbors, and form teams for later. Two to four people per team, with nice mix of skills. Give your team a name so that we can refer to it. [15]

### RStudio

Quick introduction to RStudio [NJH, 20]
...
1. Minimal R [DTK, 5] THE SLIDES WILL GO HERE.
    * data frames
    * functions and arguments
    * piping
#. Wrangling data verbs vs reduction verbs vs transformation verbs. [DTK, 10] THESE WILL BE A FEW SLIDES.  REFER TO THE CHEAT SHEET.
#. Activity: What happened to Mary and Jane? [DTK, 15] THIS WILL BE USCOTS-02.Rmd
    ...
    * `group_by()` and `summarise()`
        ...
        * Entropy?
#. Convert USCOTS-02.Rmd to be some names of interest to you. Publish to RPubs. [20]
