...
#. Activity: Visualizing a data frame
    ...
    * RMarkdown: Give these commands to open our template file in the editor.
    ```{r eval=FALSE}
...
## Example: Airline flights database
...
## Models and Machine Learning [DTK]

Link to Danny's notes WILL GO HERE
