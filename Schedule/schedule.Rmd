...
#. Activity: [What happened to Mary and Jane?](Handouts/WhatHappenedToJane/AppliedProbabilityProject.html) Download and edit the template:
    ```{r eval=FALSE}
download.file(
...
Optional: Join activity: How does the traffic depend on the distance between stations?  On how far the station is from downtown?
