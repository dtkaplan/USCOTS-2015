...
[OUTLINE TO BE MADE BY NICK]

* panes, tabs, console, editor?, open a project


* RMarkdown: Give these commands to open our template file in the editor.
    ```r
download.file("http://www.mosaic-web.org/go/datasets/DCF/USCOTS-01.Rmd", dest="USCOTS-01.Rmd")
